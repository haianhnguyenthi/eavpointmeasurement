...
// ===== Linear coefficient mV -> Acu (fitted with 5 points) =====
...
// Linear function: Acu = A * mV + B, rounded to int for printing
...
void setup() {
  ...
  Serial.begin(115200);
  Serial.setTimeout(20); // avoid long waiting when reading command
  beep(100);
...
//  // --- RECEIVE COMMAND FROM PYTHON: make one beep ---
